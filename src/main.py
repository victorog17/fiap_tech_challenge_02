...
handle_s3(r"C:\Users\Victor_1\Documents\VSCode\fiap_tech_challenge_02\src\ibov_atual.parquet",  # Corrigido
          'victor-mlet-tech-challenge-02', # Apenas o nome do bucket
          aws_access_key_id,
          aws_secret_access_key,
          'upload',
          'ibov_atual.parquet', # Caminho no S3 onde o arquivo será salvo
          'raw')
